...
const translations = {
  es: {
    ...
    heroSubtitle: 'Construyo interfaces web responsive con HTML, CSS y JavaScript, respaldado por once años de trabajo visual para música, imprenta y campañas digitales.',
  ...
  en: {
    ...
    heroSubtitle: 'I build responsive web interfaces with HTML, CSS and JavaScript, backed by eleven years of visual work for music, print and digital campaigns.',
