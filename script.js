...
const translations = {
  es: {
    ...
    card7Desc: 'Web corporativa para un centro de fisioterapia y Pilates en Águilas: navegación mediante dock flotante, contacto de doble vía (llamada directa o formulario vía Formspree) y diseño responsive con tipografía fluida. Desarrollada con React, TypeScript y Tailwind CSS.',
  ...
  en: {
    ...
    card7Title: 'Piedad Studio',
    card7Desc: 'Corporate website for a physiotherapy and Pilates studio in Águilas: floating dock navigation, dual-path contact (direct call or Formspree form) and responsive design with fluid typography. Built with React, TypeScript and Tailwind CSS.',
